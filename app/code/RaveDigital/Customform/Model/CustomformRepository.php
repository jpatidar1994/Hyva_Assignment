...
use RaveDigital\Customform\Api\CustomformRepositoryInterface;
use RaveDigital\Customform\Api\Data\CustomformInterfaceFactory;
use RaveDigital\Customform\Api\Data\CustomformSearchResultsInterfaceFactory;
use RaveDigital\Customform\Model\ResourceModel\Customform as ResourceCustomform;
use RaveDigital\Customform\Model\ResourceModel\Customform\CollectionFactory as CustomformCollectionFactory;
...
class CustomformRepository implements CustomformRepositoryInterface
{
    ...
    public function save(
        ...
        $customformData = $this->extensibleDataObjectConverter->toNestedArray(
            $customform,
            [],
            \RaveDigital\Customform\Api\Data\CustomformInterface::class
        );
    ...
    public function get($customformId)
    {
        ...
        if (!$customform->getId()) {
            throw new NoSuchEntityException(__('Inquiry with id "%1" does not exist.', $customformId));
        }
