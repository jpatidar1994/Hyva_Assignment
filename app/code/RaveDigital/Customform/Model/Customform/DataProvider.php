...
namespace RaveDigital\Customform\Model\Customform;

use RaveDigital\Customform\Model\ResourceModel\Customform\CollectionFactory;
    ...
    public function getData()
    {
        ...
        foreach ($items as $model) {
            ...
            $itemData['image'] = array(
                ...
                ).'ravedigital/customform'.$itemData['image'] // Should return a URL to view the image. For example, http://domain.com/pub/media/../../imagename.jpeg
                )
            );
			}
